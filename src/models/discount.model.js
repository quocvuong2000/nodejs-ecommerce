const { model, Schema } = require("mongoose"); // Erase if already required 516K (gzipped: 124.
...
const discountSchema = new Schema(
  {
    ...
    discount_max_uses_per_user: { type: Number, required: true }, // so luong cho phep toi da du
